    ...
    with tab2:
        ...
        if enable_openai_api:
            ...
            general_insights_prompt = (
                ...
                "\n"
                "Each point should be a logical, simple, and concise sentence that provides value. Do not name specific terms or topics, but focus on delivering direct"
                " value to business stakeholders without ambiguity. If you mention something that didn't go well, give examples based on the information.\n"
